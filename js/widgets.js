...
var Boxgrid = (function() {
	...
	function init( options ) {
		...
		$items.find( 'div.overlay-full > div span' ).fitText( 0.3 ).end().find( 'span.overlay-title' ).fitText( 0.8 ).end().find( 'span.overlay-content' ).fitText( 1.4 );
		initEvents();
	}
